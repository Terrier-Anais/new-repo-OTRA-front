...
export async function fetchAndDisplayTrips(){
    try {
        const httpResponse = await fetch(`${apiBaseUrl}/trips`); // Récupérer les trips via l'API
...
export async function createTrip(tripData){
    try {
        const httpResponse = await fetch(`${apiBaseUrl}/trips`, {
            method: 'POST',
            headers: {
